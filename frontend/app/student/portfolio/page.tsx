...
import { fetchMyPortfolios, useTemplate, createPortfolio } from "@/services/portfolio";
...
export default function StudentPortfolioPage() {
    ...
    const handleUseTemplate = async (template: Template) => {
        try {
            ...
            if (existingPortfolio && existingPortfolio.status === 'active') {
                ...
                router.push(`/student/portfolio/section?portfolio_id=${existingPortfolio.ID}`);
                return;
            }
    ...
    const handleCreatePortfolio = async () => {
        try {
            ...
            // Changed from createTemplate to createPortfolio for student
            await createPortfolio({ portfolio_name: newPortfolioName });
            alert("สร้าง Portfolio สำเร็จ");
            ...
            console.error(err);
            alert("เกิดข้อผิดพลาดในการสร้าง Portfolio");
        }
    };
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex items-center justify-between h-16">
                        <div className="hidden md:flex items-center gap-6">
                            <Link href="/student/portfolio" className="text-blue-600 font-medium hover:text-blue-700 transition border-b-2 border-blue-600 pb-1">
                                Portfolios
                            </Link>
                            <Link href="/student/portfolio/section" className="text-gray-600 hover:text-gray-900 transition pb-1">
                                Sections
                            </Link>
                        </div>
